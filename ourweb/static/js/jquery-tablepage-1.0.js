...
(function($){
	...
	$.fn.tablepage = function(oObj, dCountOfPage) {
		...
		function change_page_content()
		{
			...
			//顯示頁碼
			sPageStr = "<table style='width:8%;'><tr><td style='height:30px;'><b>第</b></td>";
			...
			for (var i = 1; i <= dCount; i += dCountOfPage)
			{
				...
				{
					sPageStr += "<td valign='top'><table style='width:20px;height:20px;cursor:pointer;color:" + sFontColor + ";border-collapse:collapse;'><tr><th>" + (dPageIndex++) + "</th></tr></table></td>";
				}
				else
				{
					sPageStr += "<td valign='top'><table style='width:20px;height:20px;cursor:pointer;color:" + sNoSelColor + ";border-collapse:collapse;'><tr><th>" + (dPageIndex++) + "</th></tr></table></td>";
				}
			}
